...
{
    glm::vec3 minCorner = glm::vec3(0.0f) - glm::vec3(1.0f) * 0.5f;
    float pad0 = 0.0f;
    glm::vec3 maxCorner = glm::vec3(0.0f) + glm::vec3(1.0f) * 0.5f;
    float pad1 = 0.0f;
    ...
    : minCorner(position - dimensions * 0.5f)
    , maxCorner(position + dimensions * 0.5f)
    , mat(mat) {}
};
